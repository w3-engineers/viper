...
import com.w3engineers.ext.viper.application.ui.dataplan.ManageSellerList;
...
//        int endPointMode = PreferencesHelper.onInstance(mContext).getEndpointMode();
        com.w3engineers.ext.viper.application.data.local.helper.PreferencesHelper preferencesHelper =
                com.w3engineers.ext.viper.application.data.local.helper.PreferencesHelper.on();
