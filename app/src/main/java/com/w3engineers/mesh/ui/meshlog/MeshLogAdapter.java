...
import com.w3engineers.ext.viper.databinding.ItemMeshLogBinding;
...
/*
 *  ****************************************************************************
 *  * Created by : Md Tariqul Islam on 8/8/2019 at 11:05 AM.
...
public class MeshLogAdapter extends BaseAdapter<MeshLogModel> implements Filterable {
    ...
    public BaseViewHolder newViewHolder(ViewGroup parent, int viewType) {
        ...
        ItemMeshLogBinding binding = DataBindingUtil.inflate(inflater, R.layout.item_mesh_log, parent, false);
    ...
    class MeshLogVH extends BaseViewHolder<MeshLogModel> {
        ItemMeshLogBinding binding;

        MeshLogVH(ViewDataBinding viewDataBinding) {
            super(viewDataBinding);
            binding = (ItemMeshLogBinding) viewDataBinding;
        }
